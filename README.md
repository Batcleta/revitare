...
| [Referências](docs/10_RESEARCH_REFERENCES.md) | projetos, modelos, concorrentes e fontes pesquisadas |

## Fontes históricas

Os documentos que deram origem à arquitetura consolidada foram preservados, sem substituí-los silenciosamente:

- [`docs/source/idea-base.md`](docs/source/idea-base.md)
- [`docs/source/research-strategy.md`](docs/source/research-strategy.md)
- [`docs/source/architecture-2026.md`](docs/source/architecture-2026.md)
- [`docs/source/master-blueprint-v3.md`](docs/source/master-blueprint-v3.md)

A documentação em `docs/00_...` até `docs/10_...` é a **fonte canônica atual**. Os arquivos em `docs/source/` existem para rastreabilidade histórica.
